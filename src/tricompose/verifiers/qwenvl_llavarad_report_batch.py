"""Score frozen LLaVA-Rad reports against their synthetic CXRs with Qwen-VL."""
...
SCHEMA_VERSION = "tricompose.qwenvl_llavarad_report_batch.v1"
PRODUCER_VERSION = "1.0.0"
LLAVARAD_SPEC = ReportRunSpec(
    candidate_id="llavarad",
    namespace="llavarad_report",
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--llavarad-run-id", required=True)
...
def _run(args: argparse.Namespace, progress: dict[str, object]) -> dict[str, object]:
    ...
    for ordinal, (source_case, report_case) in enumerate(
        ...
        record: dict[str, object] = {
            "candidate_id": LLAVARAD_SPEC.candidate_id,
    ...
    return {
        ...
        "report_run_id": args.llavarad_run_id,
        ...
        "model_summary": {LLAVARAD_SPEC.candidate_id: _aggregate(records)},
        "cost": {
            "model_loads": 1,
    ...
    try:
        ...
        frozen_path = write_private_json(
            output_dir / "frozen.json",
            {
                ...
                "source_cxr_frozen_sha256": summary[
                    "source_cxr_frozen_sha256"
                ],
        ...
        print(
            json.dumps(
                {
                    "stage": "qwenvl_llavarad_report_batch",
                    "status": "ok",
                    "case_count": summary["case_count"],
                    "candidate_count": summary["candidate_count"],
