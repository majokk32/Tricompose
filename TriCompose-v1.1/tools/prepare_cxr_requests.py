#!/usr/bin/env python3
"""Prepare exact protected V1.1 CXR requests without running a model."""
...
from tricompose_v11.cxr_contracts import prepare_cxr_request_run  # noqa: E402
from tricompose_v11.prompts import ACTIVE_PROMPT_MODELS_V11  # noqa: E402
...
def main() -> int:
    ...
    parser.add_argument("--models", default=",".join(ACTIVE_PROMPT_MODELS_V11))
