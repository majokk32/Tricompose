"""Protected paths and opaque identifiers for the PixArt experiment."""
...
PROTECTED_EXPERIMENT_ROOT = PROTECTED_ROOT / "chexgenbench_pixart" / "runs"
...
def require_source_run(run_id: str) -> Path:
    ...
    path = require_inside(SOURCE_EXPERIMENT_ROOT / run_id, PROTECTED_ROOT, must_exist=True)
    if not path.is_dir():
